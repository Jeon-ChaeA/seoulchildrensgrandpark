  ...
  async function fetchWeatherData() {
    try {
      ...
      switch (weatherCondition) {
        case 'Clear':
          iconUrl = '/images/subpage_02(운휴안내)/subpage_02_01.png'; // 맑음
          break;
        case 'Clouds':
          iconUrl = '/images/subpage_02(운휴안내)/subpage_02_02.png'; // 구름 조금
          break;
        case 'Rain':
          iconUrl = '/images/subpage_02(운휴안내)/subpage_02_05.png'; // 비
          break;
        case 'Snow':
          iconUrl = '/images/subpage_02(운휴안내)/subpage_02_06.png'; // 눈
          break;
        case 'Thunderstorm':
          iconUrl = '/images/subpage_02(운휴안내)/subpage_02_04.png'; // 번개
          break;
        default:
          iconUrl = '/images/subpage_02(운휴안내)/subpage_02_03.png'; // 구름 많음 (기본값)
          break;
      }
      ...
      updateWeather({
        ...
        windSpeed: 0.0,
        rainfall: 0.0,
        iconUrl: "/images/subpage_02(운휴안내)/subpage_02_01.png", // 기본 아이콘
      });
    }
  }
    ...
    try {
      ...
      filteredData.forEach((item, index) => {
        if (index < bottomItems.length) {
          ...
          switch (weatherCondition) {
            case 'Clear':
              customIconUrl = '/images/subpage_02(운휴안내)/subicon_02_01.svg'; // 맑음
              break;
            case 'Clouds':
              customIconUrl = '/images/subpage_02(운휴안내)/subicon_02_02.svg'; // 구름 조금
              break;
            case 'Rain':
              customIconUrl = '/images/subpage_02(운휴안내)/subicon_02_05.svg'; // 비
              break;
            case 'Snow':
              customIconUrl = '/images/subpage_02(운휴안내)/subicon_02_06.svg'; // 눈
              break;
            case 'Thunderstorm':
              customIconUrl = '/images/subpage_02(운휴안내)/subicon_02_04.svg'; // 번개
              break;
            default:
              customIconUrl = '/images/subpage_02(운휴안내)/subicon_02_03.svg'; // 기본값 (구름 많음)
              break;
          }
  ...
  async function fetchFutureWeather() {
    try {
      ...
      forecasts.forEach((forecast, index) => {
        ...
        const icon = `/images/subpage_02(운휴안내)/subicon_02_0${forecast.weatherCode}.svg`;
